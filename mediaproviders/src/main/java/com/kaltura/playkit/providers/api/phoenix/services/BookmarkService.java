...
public class BookmarkService extends PhoenixService {
    ...
    public static PhoenixRequestBuilder actionAdd(String baseUrl, int partnerId, String ks, String assetType, String contextType, String assetId, String vfastLiveAssetId, String epgId, String actionType, long position, String fileId) {
        return new PhoenixRequestBuilder()
                ...
                .params(addBookmarkGetReqParams(ks, assetId, vfastLiveAssetId, epgId, assetType, contextType, actionType, position, fileId));
    }

    private static JsonObject addBookmarkGetReqParams(String ks, String assetId, String vfastLiveAssetId, String epgId, String assetType, String contextType, String actionType, long position, String fileId) {
