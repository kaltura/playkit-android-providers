...
package providers.playkit.kaltura.com.mediaproviders.mock;
...
public class MockMediaProvider implements MediaEntryProvider {
     ...
     * next load on the same {@link com.kaltura.playkit.mediaproviders.mock.MockMediaProvider} object will not read the file again, but
    ...
    class Loader extends CallableLoader<Void> {
        ...
        Loader(OnCompletion completion) {
            super(com.kaltura.playkit.mediaproviders.mock.MockMediaProvider.TAG, completion);
        }
