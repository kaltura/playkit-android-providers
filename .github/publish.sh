...
EOF
    ...
    if [ "$RELEASE_TYPE" = "Update" ]; then
                      JSON_BODY="### Providers Plugin Support\n\n"
                      JSON_BODY="$JSON_BODY$NEW_TAG\n\n"
          JSON_BODY="$JSON_BODY * upgrade to $NEW_TAG\n\n"
          JSON_BODY="$JSON_BODY #### Gradle\n\n"
                      JSON_BODY="$JSON_BODY * implementation 'com.kaltura.playkit:playkitproviders"
      ...
      "sections": [
          {
              "facts": [
                  ...
                  {
                      "name": "Gradle line",
                      "value": "implementation 'com.kaltura.playkit:playkitproviders:$COMMIT_SHA'"
                  }
              ]
          }
      ],
